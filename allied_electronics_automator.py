"""
Automating shopping cart for Allied Electronics orders.
"""
import csv
import time
import os
...
class AlliedAutomator:
	...
	def fill_form(self, url):
		...
		self.qtyField = self.driver.find_element_by_name("ctl00$contentMain$txtQuantity")
	...
	def submit_form(self, url):
		self.driver.find_element_by_id("btnBuyClient").click()

"""Processes a Digikey CSV file containing quantity and URL.
"""
def main(fileName):
	automator = AlliedAutomator()
...
if __name__ == '__main__':
	s = input("Please input your Allied Electronics CSV file: ")
	main(s)